    ...
    public class Reader
    {
        ...
        public List<Vector3> ReadBones(IntPtr boneAddress)
        {
            ...
            foreach (var boneId in Enum.GetValues(typeof(BoneIds)))
            {
                ...
                float y = BitConverter.ToSingle(boneBytes, (int)boneId * 32 + 0);
                float z = BitConverter.ToSingle(boneBytes, (int)boneId * 32 + 0);
        ...
        public List<Vector2> ReadBones2d(List<Vector3> bones, ViewMatrix viewMatrix, Vector2 screenSize)
        {
            ...
            {
                Vector2 bone2d = Calculate.WorldToScreen2(viewMatrix, bone, (int)screenSize.X, (int)screenSize.Y);
                bones2d.Add(bone2d);
            }
            return bones2d;
        }
